...
Do NOT propose interfaces yet. Use the `AskUserQuestion` tool to ask "Which of these would you like to explore?" with each candidate as an option.
...
Use the `AskUserQuestion` tool to present the interface designs as options (including any hybrid you recommended).
