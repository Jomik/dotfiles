...
with utils;
{
  inherit buildFishPlugin buildFishPluginFromGitHub;
  prompt = {
    spacefish = buildFishPluginFromGitHub {
      owner = "matchai";
      repo = "spacefish";
      rev = "0f5a600a6c0b5861792383e69797a66923496743";
      sha256 = "07d3yhra2vfywibw218ccb423sjamqypsd2wf7gvadwizdb1l0yd";
    };
    eden = buildFishPluginFromGitHub {
      owner = "amio";
  ...
  fasd = buildFishPluginFromGitHub {
    owner = "adityavm";
    repo = "fasd";
