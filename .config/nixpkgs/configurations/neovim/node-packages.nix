...
let
  sources = {
    "@chemzqm/neovim-4.4.1" = {
      ...
      version = "4.4.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@chemzqm/neovim/-/neovim-4.4.1.tgz";
        sha512 = "5JSuzDuuIXNfb+uo0DW2iodbuJZhvicbbpiF2g1c818fBGGmh2MSBwMTwmxhV/ecH4gculOxTlOHonIkTBGqug==";
      };
    };
    "async-2.6.2" = {
      name = "async";
    ...
    "vscode-languageserver-protocol-3.15.0-next.3" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/vscode-languageserver-protocol/-/vscode-languageserver-protocol-3.15.0-next.3.tgz";
        sha512 = "UzgfXgo+2FgRj27mx2IRUyq/PYkqoh0Cy2OZsao6IGK9LNBTi5n5dICaZw4dzSCJCX8MtbkQ17oCNjcPNy+a+g==";
      };
    };
...
in
{
  "coc.nvim" = nodeEnv.buildNodePackage {
    name = "coc.nvim";
    packageName = "coc.nvim";
    version = "0.0.61";
    src = fetchurl {
      url = "https://registry.npmjs.org/coc.nvim/-/coc.nvim-0.0.61.tgz";
      sha512 = "3BX1IpVQG/2WQAt/HVwS20tTRBFJdxCA8BEY+QJghcz4uvyE0MvgalnFBCN7kwU1lJm1eZTlKncuBkTjNgevig==";
    };
    dependencies = [
      sources."@chemzqm/neovim-4.4.1"
      sources."async-2.6.2"
      ...
      (sources."vscode-languageserver-protocol-3.15.0-next.3" // {
        dependencies = [
